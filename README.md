...
**Key Points to Note:**
1. Before you run/launch the application and before you close the application, please make sure that the web service is running (for how to run the web service, please see the instructions doc: https://docs.google.com/document/d/13vS-iEMVQ-AlIvGeDwtdzvYNdbUZJN4lDgqeUlMeJg4/edit?usp=sharing). Otherwise, the application won't be able to run/be closed since it needs to communicate with the web service to get and update data stored in the cloud end.
